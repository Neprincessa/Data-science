...
# Заключение
Наивный Байес интересный, но не во всех случаях применимый алгоритм. 
Если модель классификатора строится по некорректным параметрам, то может получиться, что вероятности для других классов не могут внести большой вклад и по итогу выйдет, что классификация данных будет произведена не верно